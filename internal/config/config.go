...
func setDefaults(v *viper.Viper) {
	v.SetDefault("app.name", "notification-service")
	...
	v.SetDefault("database.schema", "notification")
	...
	v.SetDefault("jwt.issuer", "notification-service")
	...
	v.SetDefault("auth.audience", "notification-service")
	...
	v.SetDefault("migration.table", "notification_schema_migrations")
	...
	v.SetDefault("notification.dispatch_interval", "1s")
